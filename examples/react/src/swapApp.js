...
import { puffscoinInstance, bitcoinInstance } from './instances'
import { web3 } from './instances/puffscoin'
...
// Chrome
// localStorage.setItem('swap:testnet:puffs:privateKey', '"0xa6316e9e231fa70f2f41ce755f3846b74af10e8c5def8d333ec89af3b9b4193b"')
// localStorage.setItem('swap:testnet:btc:privateKey', '"cUSH65TpCkU5rsMem8WND5itr3SVF192EAKA8E5ipqs15fTJiRbc"')

// Yandex
// localStorage.setItem('swap:testnet:puffs:privateKey', '"0xe32a5cb068a13836b6bc80f54585bbfcc2d5d9089f0c5381b27d039b6d2404ec"')
...
window.clear = localStorage.clear = () => {
  ...
  localStorage.setItem('swap:testnet:puffs:privateKey', puffsPrivateKey)
...
SwapApp.setup({
  ...
  swaps: [
    ...
    new PuffsTokenSwap({
      ...
      fetchBalance: (address) => puffscoinInstance.fetchTokenBalance('0x60c205722c6c797c725a996cf9cca11291f90749', address),
    }),
    new PuffsTokenSwap({
